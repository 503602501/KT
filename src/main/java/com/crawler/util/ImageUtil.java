...
//		httpclient.getConnectionManager().shutdown(); 未做关闭不知道是否有问题
	...
	public static Error  uploadImage(String httpPath,String uploadPath) throws Exception{
		...
		try {
			...
			if(httpPath.indexOf("http://abbs.cn")!=-1){
				httpGet.setHeader("referer", "http://abbs.cn");
			}
...
//          System.out.println(image.getHeight()+" "+image.getWidth()+" "+image.getSize());
		...
		final String URL = "http://fuss10.elemecdn.com/7/6b/f8394ba70d87b49f6f8f27da34325jpeg.jpeg?imageMogr/format/jpeg/thumbnail/!640x640r/gravity/Center/crop/640x640/";
